  ...
  <body>
	...
	<div class="jumbotron">
	    <div class="container">
	      ...
	      <h1 class="display-4">Contexte</h1>
	      ...
	      <div class="row">
		    <div class="col">
		      <a class="btn btn-outline-primary btn-block" href="#" role="button">Oui</a>
		    </div>
		    <div class="col">
		      <a class="btn btn-outline-success btn-block" href="#" role="button">Non</a>
		    </div>
		  </div>
